...
/**
 * <p>
 * generate the dao class with ibatis SQL Insert type.
 * </p>
 * @author trami
 * @version 1.0
 */
public class DAOInsertBuilder extends AbstractCodeBuilder {
	/**
	 * <p>
	...
	public Block createBlock(AST ast, FastIbatisConfig fc) {
		...
		literal.setLiteralValue(Utils.stripFileExtension(fc.getXmlFileName())
				+ "." + fc.getMethodName());
	 ...
	 * </p>
	 * 
	 * @return 1 = Service Category. 2 = DAO Category.
	 */
